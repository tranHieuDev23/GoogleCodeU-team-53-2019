...
public class Comment {
    ...
    /**
     * Construct a new <code>Comment</code> object with the author and the commented
     * post's ID and the comment's content. This method is to be used when creating
     * a new comment to save into the database, in which case:
     * <ul>
    ...
    /**
     * Construct a new <code>Comment</code> object in full details. This method is
     * to be used when retrieving a comment from the database.
     * 
