...
/**
 * When User submits the form, Blobstore processes the file upload
 * and forwards the request to this servlet
...
public class ImageAnalysisServlet extends HttpServlet {
    ...
    /** 
     * Blobstore stores file as binary data
     * Function retrieves the binary data stored at the BlobKey parameter
     */
    ...
    /**
     * Uses Google Cloud Vision API to generate a list of labels
     * that apply to the image represented by the binary data stored in imgBytes
     */
