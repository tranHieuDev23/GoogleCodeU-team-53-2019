...
public class Post {
  ...
  /**
   * Construct a new <code>Post</code> object without ID, creation time and list of liked users.
   * This method is to be used when creating a new post to save into the database, in which case:
   *
   * <ul>
   *   <li>The ID will be generated randomly by the server.
   *   <li>The creation time will be the server's current time.
   *   <li>The list of liked users will be initialized as an empty list.
   * </ul>
   *
