...
public class CloudStorageHelper {
  ...
  /**
   * Retrieve an instance of class <code>StorageHelper</code>. This implementation follows the
   * Singleton Design Pattern.
   *
   * @return An instance of <code>StorageHelper</code>.
   */
  public static CloudStorageHelper getInstance() {
    if (SINGLETON_INSTANCE == null) SINGLETON_INSTANCE = new CloudStorageHelper();
  ...
  /**
   * Uploads a file part to Google Cloud Storage to the bucket specified in the <code>bucketName
   * </code> variable, appending a timestamp to end of the uploaded filename.
   *
  ...
  public Link uploadFile(Part filePart, final String bucketName)
  ...
  /**
   * Uploads a <code>List</code> of file parts to Google Cloud Storage to the bucket specified in
   * the <code>bucketName</code> variable, appending a timestamp to end of each uploaded filename.
   *
   * @param fileParts The <code>List</code> of file parts to upload.
   * @param bucketName Name of the bucket to upload to.
   * @return A <code>List</code> of <code>Link</code> objects representing the URLs to the uploaded
   *     files, in the same order in as they were in the input.
   * @throws StorageException
   * @throws IOException
   */
  public List<Link> uploadFiles(List<Part> fileParts, final String bucketName)
      throws StorageException, IOException {
