...
public class VisionAPIHelper {
  ...
  /**
   * Retrieve an instance of class <code>VisionAPIHelper</code>. This implementation follows the
   * Singleton Design Pattern.
   *
   * @return An instance of <code>VisionAPIHelper</code>.
   */
  public static VisionAPIHelper getInstance() {
    if (SINGLETON_INSTANCE == null) SINGLETON_INSTANCE = new VisionAPIHelper();
  ...
  public String[] predictTags(List<InputStream> imageStreams, int maxResultCount) {
    String[] result = null;
    /**
     * TODO: Implement tag prediction, using Vision API here. There should not be any duplicate in
     * the result.
     */
    return result;
  }
