...
public class GeoMessage {
    ...
    /**
     * Constructs a new {@link GeoMessage} posted by {@code user}, located at
     * coordinate {@code latitude, longitude} with {@code text} content. Generates a
    ...
    public GeoMessage(UUID id, String user, double latitude, double longitude, String text, long timestamp) {
        this.id = id;
        this.user = user;
        this.text = text;
