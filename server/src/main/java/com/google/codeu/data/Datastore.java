...
public class Datastore {
   ...
   *
   * @return a list of team member information, or empty list if there is no data. List is sorted by
   *     order of appearance, which is for now according to a Date/Time property named "Timestamp".
   */
  ...
  /** Returns the User owned by the email addr, or null if no matching User found */
  ...
  /** Return a set contains all users */
